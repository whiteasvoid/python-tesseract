...
print ("Websites that helped building this:")
print ("http://matrixmultiplication.xyz/")
print ("https://en.wikipedia.org/wiki/Rotation_matrix")
...
pygame.init()
pygame.display.set_caption("Experimento 4D Matrix Tesseract")
